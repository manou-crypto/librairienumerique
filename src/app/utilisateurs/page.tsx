            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border bg-muted/50">
                  ...
                  <th className="text-left px-5 py-3 text-xs font-semibold text-muted-foreground">Dernière connexion</th>
                  <th className="text-left px-5 py-3 text-xs font-semibold text-muted-foreground">Créé le</th>
                  ...
                  <tr key={user.id} className={`border-b border-border table-row-hover ${idx % 2 === 0 ? '' : 'bg-muted/20'}`}>
                    <td className="px-5 py-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="font-semibold text-foreground text-sm">{user.nom}</p>
                          <p className="text-xs text-muted-foreground">{user.email}</p>
                        </div>
                      </div>
                    </td>
                    <td className="px-5 py-3">
                      <span className={ROLE_CONFIG[user.role].className}>{ROLE_CONFIG[user.role].label}</span>
                    </td>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-xs text-primary">
                    <strong>Super Admin</strong> : accès complet · <strong>Gestionnaire</strong> : catalogue, stocks, rapports · <strong>Caissier</strong> : point de vente uniquement
                  </p>
                </div>
              </div>
            </div>
