    ...
    <Modal open={open} onClose={onClose} title="Vente enregistrée" size="sm">
      <div className="space-y-4">
        ...
        <div className="bg-muted/50 rounded-xl p-4 font-mono text-xs space-y-1.5 border border-border">
          <div className="text-center font-bold text-sm text-foreground mb-3">
            LIBRAIRIE NUMERIQUE
          </div>
          <div className="text-center text-muted-foreground mb-3">
            <p>123 Rue de la République, Alger</p>
            <p>Tél: +213 21 00 00 00</p>
          </div>
          <div className="border-t border-dashed border-border pt-2 space-y-1">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-foreground font-bold">{saleId}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-muted-foreground">Caisse</span>
              <span className="text-foreground">{caisse}</span>
            </div>
          </div>
          <div className="border-t border-dashed border-border pt-2 space-y-1">
            <div className="flex justify-between">
              <span className="text-muted-foreground">Mode paiement</span>
              <span className="text-foreground">{modeLabels[mode] || mode}</span>
            </div>
          </div>
          ...
          <div className="text-center text-muted-foreground pt-3 border-t border-dashed border-border mt-2">
        ...
        <div className="flex gap-3">
          <button
            onClick={() => {
              // BACKEND INTEGRATION: trigger print job or generate PDF receipt
              window.print();
            }}
