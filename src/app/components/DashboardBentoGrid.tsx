...
const kpiData: KPIData[] = [
  ...
  {
    id: 'kpi-ca-mois',
    label: 'CA mensuel (août)',
    value: '18 340 €',
    subValue: 'Objectif : 35 000 €',
    trend: 52.4,
    trendLabel: 'du mois atteint',
    icon: TrendingUp,
    variant: 'info',
  },
  {
    ...
    trend: 3,
    trendLabel: 'nouvelles depuis hier',
    icon: AlertTriangle,
    variant: 'warning',
  },
];
...
export default function DashboardBentoGrid() {
  return (
    <div>
      ...
      {/* Grid: 4 cols on xl/2xl, 2 on md, 1 on mobile */}
      {/* Plan: 6 cards — hero spans 2 cols (row1: hero+1+1), row2: 1+1+1 */}
        ...
        {kpiData.map((kpi) => {
          ...
          return (
            ...
            >
              ...
              {kpi.subValue && (
                <p className="text-xs text-muted-foreground mb-2">{kpi.subValue}</p>
              )}
